...
## Objetivo
Definir o protocolo operacional minimo para deploy e rollback no contexto PAP, com evidencias verificaveis para gates `S4`, `S8` e `S12`.
...
4. Validar smoke funcional dos fluxos `CORE-IA` e `CORE-COM`.
...
3. Reexecutar smoke dos fluxos core e registar impacto.
4. Abrir acao corretiva no scorecard da sprint.

## Verificacao pos-deploy
- Smoke obrigatorio para autenticacao, analise/recomendacao e compra orientada.
