# BK-MF3-05 - Permitir devoluções ou trocas com registo do motivo
...
- `guia_path`: `docs/planificacao/guias-bk/MF3/BK-MF3-05-permitir-devolucoes-ou-trocas-com-registo-do-motivo.md`
- `last_updated`: `2026-04-14`

## Contexto do BK
- Entrega alvo: implementar `Permitir devoluções ou trocas com registo do motivo` com rastreabilidade direta ao requisito `RF29`.
- Foco tecnico da macro: `Capacidades de produto I`.
- Regra de governanca: preservar IDs BK, contrato de campos e consistencia entre backlog, matriz, sprints e guias.

## Bloco pedagogico
### Objetivo
Executar `Permitir devoluções ou trocas com registo do motivo` com evidência tecnica objetiva e fecho documental alinhado ao contrato canónico.

### Pre-requisitos
- Rever `RF29` em `docs/RF.md` ou `docs/RNF.md`.
...
### Passos
1. Confirmar no backlog e na matriz o contexto do `BK-MF3-05` e do requisito `RF29`.
2. Validar pre-condicoes e dependencias declaradas (BK-MF3-04).
3. Definir contrato de entrada/saida para `Permitir devoluções ou trocas com registo do motivo`.
...
**Snippet orientado ao BK `BK-MF3-05`**

```ts
const BK_ID = 'BK-MF3-05';
const requisito = 'RF29';
