...
**Snippet tecnico orientado ao dominio de consultoria inteligente (`BK-MF3-04` / `RF28`)**
...
export function executar_bk_mf3_04(input: AnaliseInput) {
...
## Criterios de aceite
- Entrega funcional especifica de `Histórico de compras com data, total, produtos e estado (pendente, enviado, entregue)` validada contra `RF28`.
