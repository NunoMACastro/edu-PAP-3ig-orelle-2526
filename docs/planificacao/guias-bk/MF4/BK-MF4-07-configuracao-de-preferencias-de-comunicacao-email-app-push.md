# BK-MF4-07 - Configuração de preferências de comunicação (email, app, push)
...
- `guia_path`: `docs/planificacao/guias-bk/MF4/BK-MF4-07-configuracao-de-preferencias-de-comunicacao-email-app-push.md`
- `last_updated`: `2026-04-14`

## Contexto do BK
- Entrega alvo: implementar `Configuração de preferências de comunicação (email, app, push)` com rastreabilidade direta ao requisito `RF39`.
- Foco tecnico da macro: `Capacidades de produto II`.
- Regra de governanca: preservar IDs BK, contrato de campos e consistencia entre backlog, matriz, sprints e guias.

## Bloco pedagogico
### Objetivo
Executar `Configuração de preferências de comunicação (email, app, push)` com evidência tecnica objetiva e fecho documental alinhado ao contrato canónico.

### Pre-requisitos
- Rever `RF39` em `docs/RF.md` ou `docs/RNF.md`.
- Validar linha do BK no `BACKLOG-MVP.md` e na `MATRIZ-CANONICA-BK.md`.
- Confirmar dependencias declaradas: `BK-MF4-04`.
...
### Passos
1. Confirmar no backlog e na matriz o contexto do `BK-MF4-07` e do requisito `RF39`.
2. Validar pre-condicoes e dependencias declaradas (BK-MF4-04).
3. Definir contrato de entrada/saida para `Configuração de preferências de comunicação (email, app, push)`.
...
**Snippet orientado ao BK `BK-MF4-07`**

```ts
const BK_ID = 'BK-MF4-07';
const requisito = 'RF39';
