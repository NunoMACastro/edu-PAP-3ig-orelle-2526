# BK-MF4-06 - Sistema de mensagens entre cliente e consultor (chat interno)
...
- `guia_path`: `docs/planificacao/guias-bk/MF4/BK-MF4-06-sistema-de-mensagens-entre-cliente-e-consultor-chat-interno.md`
- `last_updated`: `2026-04-14`

## Contexto do BK
- Entrega alvo: implementar `Sistema de mensagens entre cliente e consultor (chat interno)` com rastreabilidade direta ao requisito `RF38`.
- Foco tecnico da macro: `Capacidades de produto II`.
- Regra de governanca: preservar IDs BK, contrato de campos e consistencia entre backlog, matriz, sprints e guias.

## Bloco pedagogico
### Objetivo
Executar `Sistema de mensagens entre cliente e consultor (chat interno)` com evidência tecnica objetiva e fecho documental alinhado ao contrato canónico.

### Pre-requisitos
- Rever `RF38` em `docs/RF.md` ou `docs/RNF.md`.
- Validar linha do BK no `BACKLOG-MVP.md` e na `MATRIZ-CANONICA-BK.md`.
- Confirmar dependencias declaradas: `BK-MF0-05`.
...
### Passos
1. Confirmar no backlog e na matriz o contexto do `BK-MF4-06` e do requisito `RF38`.
2. Validar pre-condicoes e dependencias declaradas (BK-MF0-05).
3. Definir contrato de entrada/saida para `Sistema de mensagens entre cliente e consultor (chat interno)`.
...
**Snippet orientado ao BK `BK-MF4-06`**

```ts
const BK_ID = 'BK-MF4-06';
const requisito = 'RF38';
