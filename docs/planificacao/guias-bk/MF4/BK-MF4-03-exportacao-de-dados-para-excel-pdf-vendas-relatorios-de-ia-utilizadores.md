...
## Contexto do BK
- Entrega alvo: implementar `Exportação de dados para Excel/PDF (vendas, relatórios de IA, utilizadores)` com rastreabilidade direta ao requisito `RF35`.
- Foco tecnico da macro: `Capacidades de produto II`.
- Regra de governanca: preservar IDs BK, contrato de campos e consistencia entre backlog, matriz, sprints e guias.

## Bloco pedagogico
### Objetivo
Executar `Exportação de dados para Excel/PDF (vendas, relatórios de IA, utilizadores)` com evidência tecnica objetiva e fecho documental alinhado ao contrato canónico.

### Pre-requisitos
- Rever `RF35` em `docs/RF.md` ou `docs/RNF.md`.
...
3. Definir contrato de entrada/saida para `Exportação de dados para Excel/PDF (vendas, relatórios de IA, utilizadores)`.
...
**Snippet tecnico orientado ao dominio de consultoria inteligente (`BK-MF4-03` / `RF35`)**
...
export function executar_bk_mf4_03(input: AnaliseInput) {
