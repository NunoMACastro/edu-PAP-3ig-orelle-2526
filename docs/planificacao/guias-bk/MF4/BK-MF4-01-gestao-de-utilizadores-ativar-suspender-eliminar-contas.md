...
## Contexto do BK
- Entrega alvo: implementar `Gestão de utilizadores (ativar, suspender, eliminar contas)` com rastreabilidade direta ao requisito `RF33`.
- Foco tecnico da macro: `Capacidades de produto II`.
- Regra de governanca: preservar IDs BK, contrato de campos e consistencia entre backlog, matriz, sprints e guias.

## Bloco pedagogico
### Objetivo
Executar `Gestão de utilizadores (ativar, suspender, eliminar contas)` com evidência tecnica objetiva e fecho documental alinhado ao contrato canónico.

### Pre-requisitos
- Rever `RF33` em `docs/RF.md` ou `docs/RNF.md`.
...
3. Definir contrato de entrada/saida para `Gestão de utilizadores (ativar, suspender, eliminar contas)`.
...
**Snippet tecnico orientado ao dominio hibrido (consultoria + monetizacao) (`BK-MF4-01` / `RF33`)**
...
export function executar_bk_mf4_01(evento: EventoHibrido) {
