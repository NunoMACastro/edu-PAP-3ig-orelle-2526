...
- Antes: `real_dev` já tinha `User.isActive` e alteração de role, mas não tinha fluxo completo de listar, suspender, ativar e eliminar contas.
...
- EDITAR: `real_dev/api/src/models/user.model.js`
- EDITAR: `real_dev/api/src/services/auth.service.js`
- EDITAR: `real_dev/api/src/middlewares/auth.middleware.js`
- EDITAR: `real_dev/api/src/services/admin-users.service.js`
- EDITAR: `real_dev/api/src/controllers/admin-users.controller.js`
- EDITAR: `real_dev/api/src/routes/admin-users.routes.js`
- CRIAR: `real_dev/web/src/pages/AdminUsersPage.jsx`
- EDITAR: `real_dev/web/src/App.jsx`
- REVER: `real_dev/api/src/constants/roles.js`
...
```js
// real_dev/api/src/models/user.model.js
...
2. Ficheiros envolvidos:
   - CRIAR/EDITAR: `real_dev/api/tests/mf4.admin-users.test.js`
...
```js
// real_dev/api/tests/mf4.admin-users.test.js
...
correr `npm --prefix real_dev/api test` depois de implementar a API.
7. Cenário negativo/erro esperado.
...
#### Changelog
- `2026-06-15`: guia reescrito para fluxo administrativo real em `real_dev`, com estado de conta, bloqueio de sessão, routes admin, UI e negativos `P0`.
