...
## Contexto do BK
- Entrega alvo: implementar `Moderação de comentários e avaliações` com rastreabilidade direta ao requisito `RF34`.
- Foco tecnico da macro: `Capacidades de produto II`.
- Regra de governanca: preservar IDs BK, contrato de campos e consistencia entre backlog, matriz, sprints e guias.

## Bloco pedagogico
### Objetivo
Executar `Moderação de comentários e avaliações` com evidência tecnica objetiva e fecho documental alinhado ao contrato canónico.

### Pre-requisitos
- Rever `RF34` em `docs/RF.md` ou `docs/RNF.md`.
- Validar linha do BK no `BACKLOG-MVP.md` e na `MATRIZ-CANONICA-BK.md`.
- Confirmar dependencias declaradas: `BK-MF1-03`.
...
### Passos
1. Confirmar no backlog e na matriz o contexto do `BK-MF4-02` e do requisito `RF34`.
2. Validar pre-condicoes e dependencias declaradas (BK-MF1-03).
3. Definir contrato de entrada/saida para `Moderação de comentários e avaliações`.
