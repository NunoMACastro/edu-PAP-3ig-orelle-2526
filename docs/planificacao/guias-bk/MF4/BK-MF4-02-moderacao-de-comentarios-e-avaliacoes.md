...
## Bloco pedagogico
### Objetivo
O aluno deve completar `Moderação de comentários e avaliações.` com rastreabilidade direta a `RF34`, mantendo evidence objetiva, negativos por prioridade e handoff claro.

### Pre-requisitos
- Rever `RF34` nos documentos RF/RNF aplicáveis.
