...
## Contexto do BK
- Entrega alvo: implementar `Com base na análise e histórico, o sistema recomenda produtos personalizados para o utilizador` com rastreabilidade direta ao requisito `RF18`.
- Foco tecnico da macro: `Nucleo funcional II`.
- Regra de governanca: preservar IDs BK, contrato de campos e consistencia entre backlog, matriz, sprints e guias.

## Bloco pedagogico
### Objetivo
Executar `Com base na análise e histórico, o sistema recomenda produtos personalizados para o utilizador` com evidência tecnica objetiva e fecho documental alinhado ao contrato canónico.

### Pre-requisitos
- Rever `RF18` em `docs/RF.md` ou `docs/RNF.md`.
- Validar linha do BK no `BACKLOG-MVP.md` e na `MATRIZ-CANONICA-BK.md`.
- Confirmar dependencias declaradas: `BK-MF1-06, BK-MF1-07`.
...
### Passos
1. Confirmar no backlog e na matriz o contexto do `BK-MF2-02` e do requisito `RF18`.
2. Validar pre-condicoes e dependencias declaradas (BK-MF1-06, BK-MF1-07).
3. Definir contrato de entrada/saida para `Com base na análise e histórico, o sistema recomenda produtos personalizados para o utilizador`.
...
**Snippet tecnico orientado ao dominio de consultoria inteligente (`BK-MF2-02` / `RF18`)**

```ts
const BK_ID = 'BK-MF2-02';
const REQ_ID = 'RF18';

type AnaliseInput = { userId: string; imagemId?: string; perfilId?: string };

export function executar_bk_mf2_02(input: AnaliseInput) {
...
## Criterios de aceite
- Entrega funcional especifica de `Com base na análise e histórico, o sistema recomenda produtos personalizados para o utilizador` validada contra `RF18`.
