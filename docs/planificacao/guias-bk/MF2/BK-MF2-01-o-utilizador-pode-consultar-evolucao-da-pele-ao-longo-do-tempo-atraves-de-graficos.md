...
## Contexto do BK
- Entrega alvo: implementar `O utilizador pode consultar evolução da pele ao longo do tempo através de gráficos` com rastreabilidade direta ao requisito `RF17`.
- Foco tecnico da macro: `Nucleo funcional II`.
- Regra de governanca: preservar IDs BK, contrato de campos e consistencia entre backlog, matriz, sprints e guias.

## Bloco pedagogico
### Objetivo
Executar `O utilizador pode consultar evolução da pele ao longo do tempo através de gráficos` com evidência tecnica objetiva e fecho documental alinhado ao contrato canónico.

### Pre-requisitos
- Rever `RF17` em `docs/RF.md` ou `docs/RNF.md`.
...
### Passos
1. Confirmar no backlog e na matriz o contexto do `BK-MF2-01` e do requisito `RF17`.
...
**Snippet orientado ao BK `BK-MF2-01`**

```ts
const BK_ID = 'BK-MF2-01';
const requisito = 'RF17';
