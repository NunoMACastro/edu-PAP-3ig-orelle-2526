...
## Contexto do BK
- Entrega alvo: implementar `Consultores podem rever recomendações e sugerir ajustes manuais` com rastreabilidade direta ao requisito `RF22`.
- Foco tecnico da macro: `Nucleo funcional II`.
- Regra de governanca: preservar IDs BK, contrato de campos e consistencia entre backlog, matriz, sprints e guias.

## Bloco pedagogico
### Objetivo
Executar `Consultores podem rever recomendações e sugerir ajustes manuais` com evidência tecnica objetiva e fecho documental alinhado ao contrato canónico.

### Pre-requisitos
- Rever `RF22` em `docs/RF.md` ou `docs/RNF.md`.
...
### Passos
1. Confirmar no backlog e na matriz o contexto do `BK-MF2-06` e do requisito `RF22`.
2. Validar pre-condicoes e dependencias declaradas (BK-MF2-02).
3. Definir contrato de entrada/saida para `Consultores podem rever recomendações e sugerir ajustes manuais`.
...
**Snippet orientado ao BK `BK-MF2-06`**

```ts
const BK_ID = 'BK-MF2-06';
const requisito = 'RF22';
...
## Criterios de aceite
- Entrega funcional especifica de `Consultores podem rever recomendações e sugerir ajustes manuais` validada contra `RF22`.
