# BK-MF5-03 - Configurar e aplicar códigos promocionais com limites por cliente, canal e datas
...
- `guia_path`: `docs/planificacao/guias-bk/MF5/BK-MF5-03-configurar-e-aplicar-codigos-promocionais-com-limites-por-cliente-canal-e-datas.md`
- `last_updated`: `2026-04-14`

## Contexto do BK
- Entrega alvo: implementar `Configurar e aplicar códigos promocionais com limites por cliente, canal e datas` com rastreabilidade direta ao requisito `RF43`.
- Foco tecnico da macro: `Operacao e fluxos transversais`.
- Regra de governanca: preservar IDs BK, contrato de campos e consistencia entre backlog, matriz, sprints e guias.

## Bloco pedagogico
### Objetivo
Executar `Configurar e aplicar códigos promocionais com limites por cliente, canal e datas` com evidência tecnica objetiva e fecho documental alinhado ao contrato canónico.

### Pre-requisitos
- Rever `RF43` em `docs/RF.md` ou `docs/RNF.md`.
...
### Passos
1. Confirmar no backlog e na matriz o contexto do `BK-MF5-03` e do requisito `RF43`.
2. Validar pre-condicoes e dependencias declaradas (BK-MF3-03).
3. Definir contrato de entrada/saida para `Configurar e aplicar códigos promocionais com limites por cliente, canal e datas`.
...
**Snippet orientado ao BK `BK-MF5-03`**

```ts
const BK_ID = 'BK-MF5-03';
const requisito = 'RF43';
