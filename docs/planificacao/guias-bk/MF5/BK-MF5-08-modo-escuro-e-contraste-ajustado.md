...
## Contexto do BK
- Entrega alvo: implementar `Modo escuro e contraste ajustado` com rastreabilidade direta ao requisito `RNF04`.
- Foco tecnico da macro: `Operacao e fluxos transversais`.
- Regra de governanca: preservar IDs BK, contrato de campos e consistencia entre backlog, matriz, sprints e guias.

## Bloco pedagogico
### Objetivo
Executar `Modo escuro e contraste ajustado` com evidência tecnica objetiva e fecho documental alinhado ao contrato canónico.

### Pre-requisitos
- Rever `RNF04` em `docs/RF.md` ou `docs/RNF.md`.
...
### Passos
1. Confirmar no backlog e na matriz o contexto do `BK-MF5-08` e do requisito `RNF04`.
...
**Snippet orientado ao BK `BK-MF5-08`**

```ts
const BK_ID = 'BK-MF5-08';
const requisito = 'RNF04';
