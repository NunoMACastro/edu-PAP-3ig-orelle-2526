...
## Contexto do BK
- Entrega alvo: implementar `Processar análise de fotografia em menos de 10 segundos` com rastreabilidade direta ao requisito `RNF05`.
- Foco tecnico da macro: `Qualidade e robustez`.
- Regra de governanca: preservar IDs BK, contrato de campos e consistencia entre backlog, matriz, sprints e guias.

## Bloco pedagogico
### Objetivo
Executar `Processar análise de fotografia em menos de 10 segundos` com evidência tecnica objetiva e fecho documental alinhado ao contrato canónico.

### Pre-requisitos
- Rever `RNF05` em `docs/RF.md` ou `docs/RNF.md`.
...
3. Definir contrato de entrada/saida para `Processar análise de fotografia em menos de 10 segundos`.
...
**Snippet tecnico orientado ao dominio de consultoria inteligente (`BK-MF6-01` / `RNF05`)**
...
export function executar_bk_mf6_01(input: AnaliseInput) {
