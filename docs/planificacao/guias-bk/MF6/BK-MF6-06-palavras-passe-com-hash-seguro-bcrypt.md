...
## Bloco pedagogico
### Objetivo
O aluno deve completar `Palavras-passe com hash seguro (bcrypt).` com rastreabilidade direta a `RNF10`, mantendo evidence objetiva, negativos por prioridade e handoff claro.

### Pre-requisitos
- Rever `RNF10` nos documentos RF/RNF aplicáveis.
