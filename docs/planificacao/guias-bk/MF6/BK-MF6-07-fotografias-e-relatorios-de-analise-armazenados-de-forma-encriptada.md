...
## Contexto do BK
- Entrega alvo: implementar `Fotografias e relatórios de análise armazenados de forma encriptada` com rastreabilidade direta ao requisito `RNF11`.
- Foco tecnico da macro: `Qualidade e robustez`.
- Regra de governanca: preservar IDs BK, contrato de campos e consistencia entre backlog, matriz, sprints e guias.

## Bloco pedagogico
### Objetivo
Executar `Fotografias e relatórios de análise armazenados de forma encriptada` com evidência tecnica objetiva e fecho documental alinhado ao contrato canónico.

### Pre-requisitos
- Rever `RNF11` em `docs/RF.md` ou `docs/RNF.md`.
...
### Passos
1. Confirmar no backlog e na matriz o contexto do `BK-MF6-07` e do requisito `RNF11`.
2. Validar pre-condicoes e dependencias declaradas (-).
3. Definir contrato de entrada/saida para `Fotografias e relatórios de análise armazenados de forma encriptada`.
...
**Snippet tecnico orientado ao dominio de consultoria inteligente (`BK-MF6-07` / `RNF11`)**
...
export function executar_bk_mf6_07(input: AnaliseInput) {
...
## Criterios de aceite
- Entrega funcional especifica de `Fotografias e relatórios de análise armazenados de forma encriptada` validada contra `RNF11`.
