...
## Bloco pedagogico
### Objetivo
Executar `Registar produtos com nome, descrição, ingredientes, tipo de pele indicado, imagem, preço e stock` com evidência tecnica objetiva e fecho documental alinhado ao contrato canónico.

### Pre-requisitos
- Rever `RF07` em `docs/RF.md` ou `docs/RNF.md`.
...
### Passos
1. Confirmar no backlog e na matriz o contexto do `BK-MF0-07` e do requisito `RF07`.
2. Validar pre-condicoes e dependencias declaradas (-).
3. Definir contrato de entrada/saida para `Registar produtos com nome, descrição, ingredientes, tipo de pele indicado, imagem, preço e stock`.
...
**Snippet tecnico orientado ao dominio de consultoria inteligente (`BK-MF0-07` / `RF07`)**
...
export function executar_bk_mf0_07(input: AnaliseInput) {
