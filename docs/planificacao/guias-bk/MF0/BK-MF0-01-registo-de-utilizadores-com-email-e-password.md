...
**Snippet tecnico orientado a robustez/operacao (`BK-MF0-01` / `RF01`)**

```ts
const BK_ID = 'BK-MF0-01';
const REQ_ID = 'RF01';

export function validar_bk_mf0_01(okSmoke: boolean, negativos: number, evidencias: number) {
  if (!okSmoke) throw new Error(`${BK_ID}: smoke falhou`);
  if (negativos < 3) throw new Error(`${BK_ID}: negativos insuficientes`);
