...
## Bloco pedagogico
### Objetivo
Executar `Login e logout com sessão segura (cookie HttpOnly)` com evidência tecnica objetiva e fecho documental alinhado ao contrato canónico.

### Pre-requisitos
- Rever `RF02` em `docs/RF.md` ou `docs/RNF.md`.
...
### Passos
1. Confirmar no backlog e na matriz o contexto do `BK-MF0-02` e do requisito `RF02`.
2. Validar pre-condicoes e dependencias declaradas (-).
3. Definir contrato de entrada/saida para `Login e logout com sessão segura (cookie HttpOnly)`.
