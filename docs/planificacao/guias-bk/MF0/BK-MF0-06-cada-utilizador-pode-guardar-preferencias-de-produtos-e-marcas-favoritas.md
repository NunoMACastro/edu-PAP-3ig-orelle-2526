...
## Bloco pedagogico
### Objetivo
Executar `Cada utilizador pode guardar preferências de produtos e marcas favoritas` com evidência tecnica objetiva e fecho documental alinhado ao contrato canónico.

### Pre-requisitos
- Rever `RF06` em `docs/RF.md` ou `docs/RNF.md`.
...
### Passos
1. Confirmar no backlog e na matriz o contexto do `BK-MF0-06` e do requisito `RF06`.
2. Validar pre-condicoes e dependencias declaradas (BK-MF0-03).
3. Definir contrato de entrada/saida para `Cada utilizador pode guardar preferências de produtos e marcas favoritas`.
...
**Snippet tecnico orientado ao dominio de consultoria inteligente (`BK-MF0-06` / `RF06`)**
...
export function executar_bk_mf0_06(input: AnaliseInput) {
