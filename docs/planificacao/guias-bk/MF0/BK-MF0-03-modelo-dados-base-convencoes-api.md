# BK-MF0-03 - Modelo de dados base e convenções de API
...
- `rf_rnf`: `RF03, RF07, RF13, RF27, RNF19`
- `last_updated`: `2026-04-12`

## O que vamos fazer neste BK
Neste BK vamos entregar **modelo de dados base e convenções de api** com um resultado final verificável em review e pronto para integração na macro `MF0`.
...
- Impacto funcional: habilita diretamente os requisitos `RF03, RF07, RF13, RF27, RNF19` com entrega concreta visível no produto.
...
- Impacto na sequência: desbloqueia a progressão para `BK-MF0-04` sem ambiguidade documental.
- Risco se mal executado: cria falhas de integração, regressões de qualidade ou atraso em cadeia na macro seguinte.

## O que entra (scope)
- Definir o entregável técnico e funcional de `BK-MF0-03` com critérios observáveis.
- Implementar os fluxos principais associados a `RF03, RF07, RF13, RF27, RNF19`.
...
- Trabalho de BKs seguintes, incluindo `BK-MF0-04` quando aplicável.
...
- `docs/RF.md` (secções relacionadas com `RF03, RF07, RF13, RF27, RNF19`)
- `docs/RNF.md` (secções relacionadas com `RF03, RF07, RF13, RF27, RNF19`)
...
Como fazer: validar `BK-MF0-02` no backlog, confirmar contratos e restrições de `RF03, RF07, RF13, RF27, RNF19`.
...
- `BK-MF0-04` - Mantém a sequência prevista de dependências e reduz bloqueios em macro seguinte.
