...
## Bloco pedagogico
### Objetivo
O aluno deve completar `Direito a eliminar conta e dados (incluindo fotos).` com rastreabilidade direta a `RNF13`, mantendo evidence objetiva, negativos por prioridade e handoff claro.
