...
## Contexto do BK
- Entrega alvo: implementar `Direito a eliminar conta e dados (incluindo fotos)` com rastreabilidade direta ao requisito `RNF13`.
- Foco tecnico da macro: `Privacidade, seguranca e controlo`.
- Regra de governanca: preservar IDs BK, contrato de campos e consistencia entre backlog, matriz, sprints e guias.

## Bloco pedagogico
### Objetivo
Executar `Direito a eliminar conta e dados (incluindo fotos)` com evidência tecnica objetiva e fecho documental alinhado ao contrato canónico.

### Pre-requisitos
- Rever `RNF13` em `docs/RF.md` ou `docs/RNF.md`.
...
3. Definir contrato de entrada/saida para `Direito a eliminar conta e dados (incluindo fotos)`.
...
**Snippet tecnico orientado ao dominio hibrido (consultoria + monetizacao) (`BK-MF7-02` / `RNF13`)**
...
export function executar_bk_mf7_02(evento: EventoHibrido) {
...
## Criterios de aceite
- Entrega funcional especifica de `Direito a eliminar conta e dados (incluindo fotos)` validada contra `RNF13`.
