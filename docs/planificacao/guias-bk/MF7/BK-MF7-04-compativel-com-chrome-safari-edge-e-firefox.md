...
## Contexto do BK
- Entrega alvo: implementar `Compatível com Chrome, Safari, Edge e Firefox` com rastreabilidade direta ao requisito `RNF15`.
- Foco tecnico da macro: `Privacidade, seguranca e controlo`.
- Regra de governanca: preservar IDs BK, contrato de campos e consistencia entre backlog, matriz, sprints e guias.

## Bloco pedagogico
### Objetivo
Executar `Compatível com Chrome, Safari, Edge e Firefox` com evidência tecnica objetiva e fecho documental alinhado ao contrato canónico.

### Pre-requisitos
- Rever `RNF15` em `docs/RF.md` ou `docs/RNF.md`.
...
3. Definir contrato de entrada/saida para `Compatível com Chrome, Safari, Edge e Firefox`.
...
**Snippet tecnico orientado ao dominio hibrido (consultoria + monetizacao) (`BK-MF7-04` / `RNF15`)**
...
export function executar_bk_mf7_04(evento: EventoHibrido) {
