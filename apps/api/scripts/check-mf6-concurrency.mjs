...
async function createLocalTarget() {
    if (configuredBaseUrl) {
        return {
            ...
            /**
             * Mantem a mesma interface do alvo local sem fechar recursos externos.
             *
             * @function close
             * @returns {Promise<void>} Operacao vazia quando a base URL ja existe.
             */
    ...
    return {
        baseUrl,
        /**
         * Fecha o servidor HTTP local criado apenas para este smoke.
         *
         * @function close
         * @returns {Promise<void>} Resolve quando o servidor encerra.
         */
        close: () =>
