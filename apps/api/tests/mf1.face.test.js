/**
 * Testes da MF1 para consentimento, fotografias, analise, relatorio e historico.
 */
...
describe("MF1 - fluxo facial", () => {
    ...
    it("gera relatorio a partir da analise mais recente", async () => {
        ...
        FaceReport.create.mockResolvedValueOnce({
            _id: { toString: () => reportId },
            analysisId: { toString: () => analysisId },
