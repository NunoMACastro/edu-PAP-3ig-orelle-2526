 ...
 * @param {{frontalPhoto?: object, perfilPhoto?: object}} input - Fotos já validadas pelo backend.
 * @returns {Promise<object>} Resultado estruturado da análise.
 * @throws {AppError} Quando faltam metadados obrigatórios ou imagem preparada.
 */
export async function analyzeSkinPhotos(input) {
    ...
    try {
        ...
        if (err instanceof AppError && err.statusCode < 500) {
            // Erros de input não são indisponibilidade remota e não devem virar fallback silencioso.
            throw err;
        }
