 ...
 * criar uma encomenda sem sessao de pagamento. A mesma chave idempotente usada
 * pela API reduz sessoes Stripe duplicadas em retries do browser.
 */
 ...
 * @param {string} idempotencyKey - Chave estavel da tentativa de checkout.
 ...
 * @param {object} order - Encomenda persistida.
 * @param {string} gateway - Gateway validado.
 * @param {string} idempotencyKey - Chave estavel para evitar sessoes duplicadas.
