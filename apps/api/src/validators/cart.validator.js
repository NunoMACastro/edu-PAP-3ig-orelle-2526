...
/** Valida a variante opcional usada para identificar a linha a remover. */
export function validateCartVariantQuery(query) {
    return { variantId: normalizeVariantId(query?.variantId) };
}
