...
/**
 * Valida a nota opcional de um retry administrativo.
 *
 * @function validateBiometricDataRequestRetryInput
 * @param {Record<string, unknown>} body - Corpo recebido pela API.
 * @returns {{decisionReason: string}} Nota minimizada do reprocessamento.
 */
export function validateBiometricDataRequestRetryInput(body = {}) {
    return { decisionReason: normalizeShortText(body.decisionReason) };
}
