...
/**
 * Converte a simulação persistida para DTO público.
 *
 * @function toSimulationDto
 * @param {object} simulation - Documento de simulação com produto associado.
 * @returns {object} Simulação segura para o frontend.
 */
...
/**
 * Cria simulação de maquilhagem para o utilizador autenticado.
 *
 * @async
 ...
 * @returns {Promise<object>} Simulação pública.
 */
