...
/**
 * Lista o histórico de pedidos pertencentes ao cliente autenticado.
 *
 * @async
 * @function listMyBiometricDataRequestsController
 * @param {import("express").Request & {user: {id: string}}} req - Pedido autenticado.
 * @param {import("express").Response} res - Resposta Express.
...
/**
 * Reprocessa um pedido falhado sem permitir alterar a ação ou os recursos.
 *
 * @async
 * @function retryBiometricDataRequestController
 * @param {import("express").Request & {user: {id: string, role: string}}} req - Revisor autenticado.
 * @param {import("express").Response} res - Resposta Express.
 * @param {import("express").NextFunction} next - Próximo middleware.
 * @returns {Promise<import("express").Response|void>} Resposta 200 após confirmação física.
 */
