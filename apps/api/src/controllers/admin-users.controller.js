...
/**
 * Executa desativação administrativa reversível de uma conta.
 *
 * @async
 ...
 * @param {import("express").Response} res - Resposta Express.
 * @param {import("express").NextFunction} next - Proximo middleware.
 * @returns {Promise<import("express").Response|void>} Resposta 200 com conta suspensa e sessões revogadas.
 */
