...
import {
    ...
    listFeaturedCatalogProductsController,
...
catalogRoutes.get("/categories", listPublicCategoriesController);
catalogRoutes.get("/products", listCatalogProductsController);
catalogRoutes.get("/products/featured", listFeaturedCatalogProductsController);
