...
export const FACE_PROCESSING_BLOCK_REASONS = Object.freeze({
    CONSENT_REVOKED: "consent_revoked",
    PRIVACY_REQUEST: "privacy_request",
    ACCOUNT_DELETED: "account_deleted",
});

export const FACE_PROCESSING_BLOCK_REASON_VALUES = Object.freeze(
    Object.values(FACE_PROCESSING_BLOCK_REASONS),
);
...
const userSchema = new Schema(
    {
        ...
        faceProcessingBlockReason: {
            type: String,
            enum: FACE_PROCESSING_BLOCK_REASON_VALUES,
            default: null,
            select: false,
        },
    },
