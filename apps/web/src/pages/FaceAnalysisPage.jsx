/**
 * Pagina de analise facial cosmética.
 */
import { useState } from "react";
import { apiRequest } from "../services/apiClient.js";

/**
 * Aciona a analise e mostra achados com limitacoes.
 *
 * @function FaceAnalysisPage
 * @returns {JSX.Element} UI de analise facial.
 */
export function FaceAnalysisPage() {
    ...
    /**
     * Pede ao backend que analise as fotos do utilizador autenticado.
     *
     * @async
        ...
        <section>
            ...
            {status === "success" && analysis && (
                <article>
                    ...
                    <ul>
                        {Object.entries(analysis.findings).map(
                            ([key, value]) => (
                                <li key={key}>
