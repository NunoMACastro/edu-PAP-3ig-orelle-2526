/**
 * Página mínima para revisão manual de recomendações.
 */
import { useEffect, useState } from "react";
import { apiRequest } from "../services/apiClient.js";

/**
 * Permite ao consultor ou administrador rever uma recomendação existente.
 *
 * @function ConsultantRecommendationReviewPage
 * @param {{recommendations?: object[]}} props - Recomendações carregadas no ecrã principal.
 * @returns {import("react").JSX.Element} Formulário de revisão manual.
 */
export function ConsultantRecommendationReviewPage({ recommendations = [] }) {
    ...
    /**
     * Envia a decisão de revisão manual para o endpoint de consultor.
     *
     * @async
